    ...
    <FadeInSection>
      ...
      <section className="flex flex-col items-center px-6 md:px-20 py-10 bg-cyan-600">
        <div className="w-full max-w-5xl flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1 flex justify-center">
            <div className="relative">
              <img
                src={doctorImg}
                alt="Doctor"
                className="w-[600px] h-[500px] object-cover rounded-lg shadow-lg border border-gray-200"
              />
            </div>
          </div>
          ...
          <div className="flex-1 space-y-6">
            <span className="text-white font-semibold">We Provide</span>
            ...
            {/* Promo Callout */}
            <div className="mt-4 bg-white p-4 shadow rounded-lg w-72">
      ...
      <section className="bg-gray-50 py-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8">
            <img src={partnerMedical1} alt="Partner 1" className="h-40 w-40" />
            <img src={partnerInsurance2} alt="Partner 2" className="h-40 w-40" />
            <img src={partnerHospital3} alt="Partner 3" className="h-40 w-40" />
            <img src={partnerAccreditation4} alt="Partner 4" className="h-40 w-40" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-cyan-50 py-12">
        <div className="max-w-xl mx-auto text-center">
          ...
          <button className="bg-cyan-600 text-white font-bold px-8 py-3 rounded-lg shadow hover:bg-cyan-700 transition">
            Book Appointment
          </button>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow flex flex-col justify-center items-center">
              <div className="font-semibold text-cyan-700 mb-2">Visit Us:</div>
              <div className="text-gray-800 mb-4 text-center">
                123 Health Road, Medical City, India
              </div>
